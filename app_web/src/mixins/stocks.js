        ...
        generateClosedTrades(container, trades, active) {
            ...
            organizer.forEach((group) => {
                ...
                if (buffer) {
                    ...
                    this.axios
                        .get(
                            "https://phisix-api.appspot.com/stocks/" + buffer.stockCode + ".json"
                        )
                        .then((response) => {
